...
/**
 * Stopping the crawler being used to read the inside of our own network.
 *
 * "Import my website" takes a URL from a user and makes the *server* fetch it.
 ...
 * base afterwards, one passage at a time.
 *
